...
const rootReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.API_CALL_NETWORKS_SUCCESS:
            return { ...state, fetching: false, networks: action.networks };
        ...
        case actionTypes.API_CALL_BICYCLES_SUCCESS:
            return { ...state, fetching: false, bicycles: action.bicycles };
        case actionTypes.API_CALL_BICYCLES_FAIL:
            return { ...state, fetching: false, bicycles: null, error: action.error };
        default:
            return state;
    }
}
